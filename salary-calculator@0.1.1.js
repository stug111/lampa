...
function fD() {
  if (tR) return St;
  tR = 1;
  var F = Symbol.for("react.element"), q = Symbol.for("react.portal"), D = Symbol.for("react.fragment"), de = Symbol.for("react.strict_mode"), Ye = Symbol.for("react.profiler"), bt = Symbol.for("react.provider"), De = Symbol.for("react.context"), S = Symbol.for("react.forward_ref"), Je = Symbol.for("react.suspense"), Ne = Symbol.for("react.memo"), se = Symbol.for("react.lazy"), Qe = Symbol.iterator;
  function ee(b) {
  ...
  function We(b, $, Oe) {
    var Be, tt = {}, ut = null, mt = null;
    if ($ != null) for (Be in $.ref !== void 0 && (mt = $.ref), $.key !== void 0 && (ut = "" + $.key), $) Nt.call($, Be) && !dt.hasOwnProperty(Be) && (tt[Be] = $[Be]);
    var ft = arguments.length - 2;
    if (ft === 1) tt.children = Oe;
    else if (1 < ft) {
      for (var Ct = Array(ft), Pt = 0; Pt < ft; Pt++) Ct[Pt] = arguments[Pt + 2];
      tt.children = Ct;
    }
    if (b && b.defaultProps) for (Be in ft = b.defaultProps, ft) tt[Be] === void 0 && (tt[Be] = ft[Be]);
    return { $$typeof: F, type: b, key: ut, ref: mt, props: tt, _owner: Re.current };
  }
  function xn(b, $) {
  ...
  function Pe(b, $, Oe, Be, tt) {
    ...
    if (mt) return mt = b, tt = tt(mt), b = Be === "" ? "." + nn(mt, 0) : Be, Ve(tt) ? (Oe = "", b != null && (Oe = b.replace(Et, "$&/") + "/"), Pe(tt, $, Oe, "", function(Pt) {
      return Pt;
    })) : tt != null && (gn(tt) && (tt = xn(tt, Oe + (!tt.key || mt && mt.key === tt.key ? "" : ("" + tt.key).replace(Et, "$&/") + "/") + b)), $.push(tt)), 1;
    if (mt = 0, Be = Be === "" ? "." : Be + ":", Ve(b)) for (var ft = 0; ft < b.length; ft++) {
      ut = b[ft];
      var Ct = Be + nn(ut, ft);
      mt += Pe(ut, $, Oe, Ct, tt);
    }
    else if (Ct = ee(b), typeof Ct == "function") for (b = Ct.call(b), ft = 0; !(ut = b.next()).done; ) ut = ut.value, Ct = Be + nn(ut, ft++), mt += Pe(ut, $, Oe, Ct, tt);
  ...
  return St.Children = { map: at, forEach: function(b, $, Oe) {
    ...
    return b;
  } }, St.Component = vt, St.Fragment = D, St.Profiler = Ye, St.PureComponent = sn, St.StrictMode = de, St.Suspense = Je, St.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = me, St.act = ie, St.cloneElement = function(b, $, Oe) {
    if (b == null) throw Error("React.cloneElement(...): The argument must be a React element, but you passed " + b + ".");
    var Be = ue({}, b.props), tt = b.key, ut = b.ref, mt = b._owner;
    if ($ != null) {
      if ($.ref !== void 0 && (ut = $.ref, mt = Re.current), $.key !== void 0 && (tt = "" + $.key), b.type && b.type.defaultProps) var ft = b.type.defaultProps;
    ...
    return { $$typeof: F, type: b.type, key: tt, ref: ut, props: Be, _owner: mt };
  }, St.createContext = function(b) {
    return b = { $$typeof: De, _currentValue: b, _currentValue2: b, _threadCount: 0, Provider: null, Consumer: null, _defaultValue: null, _globalName: null }, b.Provider = { $$typeof: bt, _context: b }, b.Consumer = b;
    ...
    return { $$typeof: se, _payload: { _status: -1, _result: b }, _init: xt };
  }, St.memo = function(b, $) {
...
function dD() {
  return nR || (nR = 1, function(F, q) {
    ...
    D.NODE_ENV !== "production" && function() {
      ...
      var de = "18.3.1", Ye = Symbol.for("react.element"), bt = Symbol.for("react.portal"), De = Symbol.for("react.fragment"), S = Symbol.for("react.strict_mode"), Je = Symbol.for("react.profiler"), Ne = Symbol.for("react.provider"), se = Symbol.for("react.context"), Qe = Symbol.for("react.forward_ref"), ee = Symbol.for("react.suspense"), je = Symbol.for("react.suspense_list"), ue = Symbol.for("react.memo"), Ce = Symbol.for("react.lazy"), vt = Symbol.for("react.offscreen"), Fn = Symbol.iterator, sn = "@@iterator";
      function lt(h) {
      ...
      xt.ReactDebugCurrentFrame = We, xt.ReactCurrentActQueue = Re;
      function it(h) {
        {
      ...
      Xn.constructor = Pt, Oe(Xn, tt.prototype), Xn.isPureReactComponent = !0;
      function Fr() {
        var h = {
          current: null
        };
      ...
      function Vn(h) {
        ...
        if (typeof h == "object")
          switch (h.$$typeof) {
            ...
            case Ce: {
              var J = h, Se = J._payload, pe = J._init;
              try {
                return Vn(pe(Se));
              } catch {
                return null;
      ...
      var ne = function(h, C, M, j, J, Se, pe) {
        var $e = {
      ...
      function ke(h, C, M) {
        var j, J = {}, Se = null, pe = null, $e = null, ct = null;
        if (C != null) {
          Sr(C) && (pe = C.ref, oa(C)), cn(C) && (Nn(C.key), Se = "" + C.key), $e = C.__self === void 0 ? null : C.__self, ct = C.__source === void 0 ? null : C.__source;
          for (j in C)
        ...
        if (Se || pe) {
          ...
          Se && la(J, an), pe && ua(J, an);
        }
        return ne(h, Se, pe, $e, ct, dt.current, J);
      }
      function ot(h, C) {
      ...
      function At(h, C, M) {
        ...
        var j, J = Oe({}, h.props), Se = h.key, pe = h.ref, $e = h._self, ct = h._source, Ht = h._owner;
        if (C != null) {
          Sr(C) && (pe = C.ref, Ht = dt.current), cn(C) && (Nn(C.key), Se = "" + C.key);
          var $t;
        ...
        return ne(h.type, Se, pe, $e, ct, Ht, J);
      }
      function Lt(h) {
        ...
        if (h._status === Xa) {
          ...
          if (M.then(function(Se) {
            if (h._status === Da || h._status === Xa) {
              var pe = h;
              pe._status = Mi, pe._result = Se;
            }
          }, function(Se) {
            if (h._status === Da || h._status === Xa) {
              var pe = h;
              pe._status = Er, pe._result = Se;
            }
          }), h._status === Xa) {
            var j = h;
...
Your code should look like: 
  const MyComponent = lazy(() => import('./MyComponent'))`, J), J.default;
      ...
      function R(h) {
        return !!(typeof h == "string" || typeof h == "function" || h === De || h === Je || at || h === S || h === ee || h === je || Pe || h === vt || Jt || Et || nn || typeof h == "object" && h !== null && (h.$$typeof === Ce || h.$$typeof === ue || h.$$typeof === Ne || h.$$typeof === se || h.$$typeof === Qe || // This needs to include all possible module reference object
          ...
          for (var pe in h)
            if (Se(h, pe)) {
              ...
              try {
                ...
                $e = h[pe](C, pe, j, M, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
              } catch (Ht) {
                $e = Ht;
              }
              $e && !($e instanceof Error) && (Rl(J), B("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", j || "React class", M, pe, typeof $e), Rl(null)), $e instanceof Error && !($e.message in rs) && (rs[$e.message] = !0, Rl(J), B("Failed %s type: %s", M, $e.message), Rl(null));
            }
        }
      }
      function gt(h) {
...
Check the top-level render call using <` + M + ">.");
        ...
        if (typeof h == "object") {
          if (Sn(h))
            ...
            if (typeof J == "function" && J !== h.entries)
              for (var Se = J.call(h), pe; !(pe = Se.next()).done; )
      ...
      function is(h, C, M) {
        ...
        if (!j) {
          ...
          Se ? J += Se : J += su();
          var pe;
          h === null ? pe = "null" : Sn(h) ? pe = "array" : h !== void 0 && h.$$typeof === Ye ? (pe = "<" + (Vn(h.type) || "Unknown") + " />", J = " Did you accidentally export a JSX literal instead of a component?") : pe = typeof h, B("React.createElement: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", pe, J);
        }
      ...
      q.Children = eo, q.Component = tt, q.Fragment = De, q.Profiler = Je, q.PureComponent = Pt, q.StrictMode = S, q.Suspense = ee, q.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = xt, q.act = du, q.cloneElement = ls, q.createContext = qa, q.createElement = Zu, q.createFactory = Za, q.createRef = Fr, q.forwardRef = zi, q.isValidElement = Lt, q.lazy = sa, q.memo = Q, q.startTransition = Ku, q.unstable_act = du, q.useCallback = fn, q.useContext = Me, q.useDebugValue = ka, q.useDeferredValue = Vr, q.useEffect = st, q.useId = nt, q.useImperativeHandle = Ft, q.useInsertionEffect = Ln, q.useLayoutEffect = Gt, q.useMemo = hr, q.useReducer = Rt, q.useRef = Ae, q.useState = pt, q.useSyncExternalStore = Ui, q.useTransition = Mn, q.version = de, typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u" && typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop == "function" && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop(new Error());
    }();
...
function nv() {
  ...
  rR = 1;
  var F = {};
  return F.NODE_ENV === "production" ? Bm.exports = fD() : Bm.exports = dD(), Bm.exports;
}
/**
 * @license React
...
function pD() {
  if (aR) return Jp;
  aR = 1;
  var F = nv(), q = Symbol.for("react.element"), D = Symbol.for("react.fragment"), de = Object.prototype.hasOwnProperty, Ye = F.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, bt = { key: !0, ref: !0, __self: !0, __source: !0 };
  function De(S, Je, Ne) {
    var se, Qe = {}, ee = null, je = null;
    Ne !== void 0 && (ee = "" + Ne), Je.key !== void 0 && (ee = "" + Je.key), Je.ref !== void 0 && (je = Je.ref);
    for (se in Je) de.call(Je, se) && !bt.hasOwnProperty(se) && (Qe[se] = Je[se]);
    if (S && S.defaultProps) for (se in Je = S.defaultProps, Je) Qe[se] === void 0 && (Qe[se] = Je[se]);
    return { $$typeof: q, type: S, key: ee, ref: je, props: Qe, _owner: Ye.current };
  }
  return Jp.Fragment = D, Jp.jsx = De, Jp.jsxs = De, Jp;
}
var Zp = {}, iR;
function vD() {
  if (iR) return Zp;
  ...
  return F.NODE_ENV !== "production" && function() {
    var q = nv(), D = Symbol.for("react.element"), de = Symbol.for("react.portal"), Ye = Symbol.for("react.fragment"), bt = Symbol.for("react.strict_mode"), De = Symbol.for("react.profiler"), S = Symbol.for("react.provider"), Je = Symbol.for("react.context"), Ne = Symbol.for("react.forward_ref"), se = Symbol.for("react.suspense"), Qe = Symbol.for("react.suspense_list"), ee = Symbol.for("react.memo"), je = Symbol.for("react.lazy"), ue = Symbol.for("react.offscreen"), Ce = Symbol.iterator, vt = "@@iterator";
    function Fn(R) {
    ...
    var Nt = !1, Re = !1, dt = !1, We = !1, xn = !1, gn;
    gn = Symbol.for("react.module.reference");
    function Jt(R) {
      return !!(typeof R == "string" || typeof R == "function" || R === Ye || R === De || xn || R === bt || R === se || R === Qe || We || R === ue || Nt || Re || dt || typeof R == "object" && R !== null && (R.$$typeof === je || R.$$typeof === ee || R.$$typeof === S || R.$$typeof === Je || R.$$typeof === Ne || // This needs to include all possible module reference object
      // types supported by any Flight configuration anywhere since
      // we don't know which Flight build this will end up being used
      // with.
...
` + ft + R;
    ...
    function fr(R, Q) {
      ...
      Error.prepareStackTrace = void 0;
      var Rt;
      Rt = mt.current, mt.current = null, tt();
      try {
        if (Q) {
          var Ae = function() {
            throw Error();
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`, Vr, ka, nt, ka), Mi[ka + Vr] = !0;
    ...
    var zi = sa, gl = Hr;
    Zp.Fragment = Ye, Zp.jsx = zi, Zp.jsxs = gl;
  }(), Zp;
}
var lR;
function hD() {
  ...
  lR = 1;
  var F = {};
  return F.NODE_ENV === "production" ? Pm.exports = pD() : Pm.exports = vD(), Pm.exports;
}
var et = hD(), S0 = nv(), Bf = {}, $m = { exports: {} }, Qa = {}, Im = { exports: {} }, y0 = {};
/**
 * @license React
...
function mD() {
  return uR || (uR = 1, function(F) {
    ...
    function de(B) {
      ...
      if (ie !== me) {
        ...
        e: for (var b = 0, $ = B.length, Oe = $ >>> 1; b < Oe; ) {
          var Be = 2 * (b + 1) - 1, tt = B[Be], ut = Be + 1, mt = B[ut];
          if (0 > Ye(tt, ie)) ut < $ && 0 > Ye(mt, tt) ? (B[b] = mt, B[ut] = ie, b = ut) : (B[b] = tt, B[Be] = ie, b = Be);
          else if (ut < $ && 0 > Ye(mt, ie)) B[b] = mt, B[ut] = ie, b = ut;
          else break e;
        }
      }
      return me;
    ...
    if (typeof performance == "object" && typeof performance.now == "function") {
      ...
      var De = Date, S = De.now();
      F.unstable_now = function() {
        return De.now() - S;
      };
    }
    var Je = [], Ne = [], se = 1, Qe = null, ee = 3, je = !1, ue = !1, Ce = !1, vt = typeof setTimeout == "function" ? setTimeout : null, Fn = typeof clearTimeout == "function" ? clearTimeout : null, sn = typeof setImmediate < "u" ? setImmediate : null;
    typeof navigator < "u" && navigator.scheduling !== void 0 && navigator.scheduling.isInputPending !== void 0 && navigator.scheduling.isInputPending.bind(navigator.scheduling);
    function lt(B) {
      for (var me = D(Ne); me !== null; ) {
        if (me.callback === null) de(Ne);
        else if (me.startTime <= B) de(Ne), me.sortIndex = me.expirationTime, q(Je, me);
        else break;
        me = D(Ne);
      }
    }
    function Ve(B) {
      if (Ce = !1, lt(B), !ue) if (D(Je) !== null) ue = !0, xt(Nt);
      else {
        var me = D(Ne);
    ...
    function Nt(B, me) {
      ue = !1, Ce && (Ce = !1, Fn(We), We = -1), je = !0;
      var ie = ee;
      try {
        for (lt(me), Qe = D(Je); Qe !== null && (!(Qe.expirationTime > me) || B && !Jt()); ) {
          var b = Qe.callback;
          if (typeof b == "function") {
            Qe.callback = null, ee = Qe.priorityLevel;
            var $ = b(Qe.expirationTime <= me);
            me = F.unstable_now(), typeof $ == "function" ? Qe.callback = $ : Qe === D(Je) && de(Je), lt(me);
          } else de(Je);
          Qe = D(Je);
        }
        if (Qe !== null) var Oe = !0;
    ...
    var Re = !1, dt = null, We = -1, xn = 5, gn = -1;
    function Jt() {
    ...
    F.unstable_IdlePriority = 5, F.unstable_ImmediatePriority = 1, F.unstable_LowPriority = 4, F.unstable_NormalPriority = 3, F.unstable_Profiling = null, F.unstable_UserBlockingPriority = 2, F.unstable_cancelCallback = function(B) {
      ...
      return $ = ie + $, B = { id: se++, callback: me, priorityLevel: B, startTime: ie, expirationTime: $, sortIndex: -1 }, ie > b ? (B.sortIndex = ie, q(Ne, B), D(Je) === null && B === D(Ne) && (Ce ? (Fn(We), We = -1) : Ce = !0, it(Ve, ie - b))) : (B.sortIndex = $, q(Je, B), ue || je || (ue = !0, xt(Nt))), B;
    ...
    q.NODE_ENV !== "production" && function() {
      ...
      function Ne(ne, ke, ot) {
        for (var At = ot, Lt = ne.length, bn = Lt >>> 1; At < bn; ) {
          ...
          if (se(vr, ke) < 0)
            Bt < Lt && se(In, vr) < 0 ? (ne[At] = In, ne[Bt] = ke, At = Bt) : (ne[At] = vr, ne[pn] = ke, At = pn);
          else if (Bt < Lt && se(In, ke) < 0)
      ...
      var Nt = 1073741823, Re = -1, dt = 250, We = 5e3, xn = 1e4, gn = Nt, Jt = [], Et = [], nn = 1, Pe = null, at = je, xt = !1, it = !1, B = !1, me = typeof setTimeout == "function" ? setTimeout : null, ie = typeof clearTimeout == "function" ? clearTimeout : null, b = typeof setImmediate < "u" ? setImmediate : null;
      typeof navigator < "u" && navigator.scheduling !== void 0 && navigator.scheduling.isInputPending !== void 0 && navigator.scheduling.isInputPending.bind(navigator.scheduling);
      function $(ne) {
        for (var ke = De(Et); ke !== null; ) {
          if (ke.callback === null)
            S(Et);
      ...
      function tt(ne, ke) {
        var ot = ke;
        for ($(ot), Pe = De(Jt); Pe !== null && !D && !(Pe.expirationTime > ot && (!ne || dr())); ) {
          var At = Pe.callback;
          if (typeof At == "function") {
            Pe.callback = null, at = Pe.priorityLevel;
            var Lt = Pe.expirationTime <= ot, bn = At(Lt);
            ot = F.unstable_now(), typeof bn == "function" ? Pe.callback = bn : Pe === De(Jt) && S(Jt), $(ot);
          } else
            S(Jt);
          Pe = De(Jt);
        }
      ...
      function Ct(ne, ke, ot) {
        ...
        return Lt > At ? (Bt.sortIndex = Lt, bt(Et, Bt), De(Jt) === null && Bt === De(Et) && (B ? la() : B = !0, cn(Oe, Lt - At))) : (Bt.sortIndex = vr, bt(Jt, Bt), !it && !xt && (it = !0, Sr(Be))), Bt;
      }
      function Pt() {
      }
      function Xn() {
      ...
      var Kn = !1, Hn = null, wn = -1, Nn = Ye, gr = -1;
      function dr() {
      ...
      function ra(ne) {
        ...
        ne > 0 ? Nn = Math.floor(1e3 / ne) : Nn = Ye;
      }
      var aa = function() {
        if (Hn !== null) {
      ...
      var ua = Vn, oa = null;
      F.unstable_IdlePriority = Ce, F.unstable_ImmediatePriority = Qe, F.unstable_LowPriority = ue, F.unstable_NormalPriority = je, F.unstable_Profiling = oa, F.unstable_UserBlockingPriority = ee, F.unstable_cancelCallback = fr, F.unstable_continueExecution = Xn, F.unstable_forceFrameRate = ra, F.unstable_getCurrentPriorityLevel = Sn, F.unstable_getFirstCallbackNode = Fr, F.unstable_next = mt, F.unstable_pauseExecution = Pt, F.unstable_requestPaint = ua, F.unstable_runWithPriority = ut, F.unstable_scheduleCallback = Ct, F.unstable_shouldYield = dr, F.unstable_wrapCallback = ft, typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u" && typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop == "function" && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop(new Error());
    }();
  }(g0)), g0;
}
var sR;
function gR() {
  ...
  sR = 1;
  var F = {};
  return F.NODE_ENV === "production" ? Im.exports = mD() : Im.exports = yD(), Im.exports;
}
/**
 * @license React
...
function gD() {
  ...
  var de = /* @__PURE__ */ new Set(), Ye = {};
  function bt(n, r) {
    De(n, r), De(n + "Capture", r);
  }
  function De(n, r) {
    for (Ye[n] = r, n = 0; n < r.length; n++) de.add(r[n]);
  }
  var S = !(typeof window > "u" || typeof window.document > "u" || typeof window.document.createElement > "u"), Je = Object.prototype.hasOwnProperty, Ne = /^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/, se = {}, Qe = {};
  function ee(n) {
    return Je.call(Qe, n) ? !0 : Je.call(se, n) ? !1 : Ne.test(n) ? Qe[n] = !0 : (se[n] = !0, !1);
  }
  function je(n, r, l, o) {
...
` + c[m].replace(" at new ", " at ");
  ...
  }, defaultPrevented: 0, isTrusted: 0 }, $e = Se(pe), ct = ie({}, pe, { view: 0, detail: 0 }), Ht = Se(ct), $t, It, Yt, an = ie({}, ct, { screenX: 0, screenY: 0, clientX: 0, clientY: 0, pageX: 0, pageY: 0, ctrlKey: 0, shiftKey: 0, altKey: 0, metaKey: 0, getModifierState: gc, button: 0, buttons: 0, relatedTarget: function(n) {
  ...
  } }), wt = Se(an), xl = ie({}, an, { dataTransfer: 0 }), to = Se(xl), us = ie({}, ct, { relatedTarget: 0 }), os = Se(us), Pi = ie({}, pe, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }), ss = Se(Pi), cs = ie({}, pe, { clipboardData: function(n) {
    return "clipboardData" in n ? n.clipboardData : window.clipboardData;
  } }), $f = Se(cs), Qm = ie({}, pe, { data: 0 }), rv = Se(Qm), av = {
    Esc: "Escape",
    Spacebar: " ",
    Left: "ArrowLeft",
    Up: "ArrowUp",
  ...
  } }), Bi = Se(Wm), Gm = ie({}, an, { pointerId: 0, width: 0, height: 0, pressure: 0, tangentialPressure: 0, tiltX: 0, tiltY: 0, twist: 0, pointerType: 0, isPrimary: 0 }), Sc = Se(Gm), Yf = ie({}, ct, { touches: 0, targetTouches: 0, changedTouches: 0, altKey: 0, metaKey: 0, ctrlKey: 0, shiftKey: 0, getModifierState: gc }), Qf = Se(Yf), qm = ie({}, pe, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }), Ec = Se(qm), uv = ie({}, an, {
    deltaX: function(n) {
  ...
  Dl(mr, "onAnimationEnd"), Dl(Zf, "onAnimationIteration"), Dl(Tv, "onAnimationStart"), Dl("dblclick", "onDoubleClick"), Dl("focusin", "onFocus"), Dl("focusout", "onBlur"), Dl(_v, "onTransitionEnd"), De("onMouseEnter", ["mouseout", "mouseover"]), De("onMouseLeave", ["mouseout", "mouseover"]), De("onPointerEnter", ["pointerout", "pointerover"]), De("onPointerLeave", ["pointerout", "pointerover"]), bt("onChange", "change click focusin focusout input keydown keyup selectionchange".split(" ")), bt("onSelect", "focusout contextmenu dragend focusin keydown keyup mousedown mouseup selectionchange".split(" ")), bt("onBeforeInput", ["compositionend", "keypress", "textInput", "paste"]), bt("onCompositionEnd", "compositionend focusout keydown keypress keyup mousedown".split(" ")), bt("onCompositionStart", "compositionstart focusout keydown keypress keyup mousedown".split(" ")), bt("onCompositionUpdate", "compositionupdate focusout keydown keypress keyup mousedown".split(" "));
  ...
  function td(n, r, l, o, c) {
    ...
    yl(function() {
      ...
      if (!(r & 7)) {
        ...
        e: {
          if (Y = U ? lo(U) : window, ce = Y.nodeName && Y.nodeName.toLowerCase(), ce === "select" || ce === "input" && Y.type === "file") var _e = qf;
          else if (Gf(Y)) if (Xf) _e = ny;
          else {
            _e = ey;
            var Fe = Zm;
          }
          else (ce = Y.nodeName) && ce.toLowerCase() === "input" && (Y.type === "checkbox" || Y.type === "radio") && (_e = ty);
          if (_e && (_e = _e(n, U))) {
            fv(X, _e, l, W);
            break e;
          }
        ...
        we && (fs && l.locale !== "ko" && (wl || we !== "onCompositionStart" ? we === "onCompositionEnd" && wl && (He = C()) : (Za = W, eo = "value" in Za ? Za.value : Za.textContent, wl = !0)), Fe = wc(U, we), 0 < Fe.length && (we = new rv(we, n, null, l, W), X.push({ event: we, listeners: Fe }), He ? we.data = He : (He = cv(l), He !== null && (we.data = He)))), (He = Wf ? Xm(n, l) : Km(n, l)) && (U = wc(U, "onBeforeInput"), 0 < U.length && (W = new rv("onBeforeInput", "beforeinput", null, l, W), X.push({ event: W, listeners: U }), W.data = He));
      }
      Dv(X, r);
    });
  }
...
`).replace(rd, "");
  ...
  function Lv(n, r, l) {
    ...
    l ? (n = kl(n, r, Rr), o.__reactInternalMemoizedMergedChildContext = n, Te(Xe), Te(Yn), Mt(Yn, n)) : Te(Xe), Mt(Xe, l);
  }
  ...
  function Uv(n) {
    ...
    function T(k, x, L, Z) {
      var _e = L.type;
      return _e === dt ? W(k, x, L.props.children, Z, L.key) : x !== null && (x.elementType === _e || typeof _e == "object" && _e !== null && _e.$$typeof === xt && zl(_e) === x.type) ? (Z = c(x, L.props), Z.ref = Ml(k, x, L), Z.return = k, Z) : (Z = af(L.type, L.key, L.props, null, k.mode, Z), Z.ref = Ml(k, x, L), Z.return = k, Z);
    }
    function U(k, x, L, Z) {
    ...
    function W(k, x, L, Z, _e) {
      return x === null || x.tag !== 7 ? (x = zu(L, k.mode, Z, _e), x.return = k, x) : (x = c(x, L), x.return = k, x);
    }
    function X(k, x, L) {
    ...
    function ce(k, x, L, Z, _e) {
      ...
      if (typeof Z == "object" && Z !== null) {
        switch (Z.$$typeof) {
          ...
          case xt:
            var Fe = Z._init;
            return ce(k, x, L, Fe(Z._payload), _e);
        }
    ...
    function ye(k, x, L, Z) {
      for (var _e = null, Fe = null, He = x, we = x = 0, _n = null; He !== null && we < L.length; we++) {
        He.index > we ? (_n = He, He = null) : _n = He.sibling;
        var Ot = Y(k, He, L[we], Z);
        if (Ot === null) {
          He === null && (He = _n);
          break;
        }
        n && He && Ot.alternate === null && r(k, He), x = d(Ot, x, we), Fe === null ? _e = Ot : Fe.sibling = Ot, Fe = Ot, He = _n;
      }
      if (we === L.length) return l(k, He), ln && Su(k, we), _e;
      if (He === null) {
        for (; we < L.length; we++) He = X(k, L[we], Z), He !== null && (x = d(He, x, we), Fe === null ? _e = He : Fe.sibling = He, Fe = He);
        return ln && Su(k, we), _e;
      }
      for (He = o(k, He); we < L.length; we++) _n = ce(He, k, we, L[we], Z), _n !== null && (n && _n.alternate !== null && He.delete(_n.key === null ? we : _n.key), x = d(_n, x, we), Fe === null ? _e = _n : Fe.sibling = _n, Fe = _n);
    ...
    function Ee(k, x, L, Z) {
      ...
      for (var Fe = _e = null, He = x, we = x = 0, _n = null, Ot = L.next(); He !== null && !Ot.done; we++, Ot = L.next()) {
        He.index > we ? (_n = He, He = null) : _n = He.sibling;
        ...
        n && He && Ql.alternate === null && r(k, He), x = d(Ql, x, we), Fe === null ? _e = Ql : Fe.sibling = Ql, Fe = Ql, He = _n;
      }
      if (Ot.done) return l(
        k,
        He
      ...
      if (He === null) {
        for (; !Ot.done; we++, Ot = L.next()) Ot = X(k, Ot.value, Z), Ot !== null && (x = d(Ot, x, we), Fe === null ? _e = Ot : Fe.sibling = Ot, Fe = Ot);
        return ln && Su(k, we), _e;
      }
      for (He = o(k, He); !Ot.done; we++, Ot = L.next()) Ot = ce(He, k, we, Ot.value, Z), Ot !== null && (n && Ot.alternate !== null && He.delete(Ot.key === null ? we : Ot.key), x = d(Ot, x, we), Fe === null ? _e = Ot : Fe.sibling = Ot, Fe = Ot);
            ...
            e: {
              for (var _e = L.key, Fe = x; Fe !== null; ) {
                if (Fe.key === _e) {
                  ...
                  } else if (Fe.elementType === _e || typeof _e == "object" && _e !== null && _e.$$typeof === xt && zl(_e) === Fe.type) {
  ...
  var Fc = Ve.ReactCurrentDispatcher, Cd = Ve.ReactCurrentBatchConfig, Ji = 0, re = null, Le = null, qe = null, un = !1, qr = !1, vo = 0, oy = 0;
  function yr() {
    throw Error(D(321));
  }
  function Rd(n, r) {
...
` + d.stack;
  ...
  function dy(n, r, l) {
    ...
    switch (Nc(r), r.tag) {
      ...
      case 3:
        return o = r.stateNode, po(), Te(Xe), Te(Yn), jc(), o.pendingContext && (o.context = o.pendingContext, o.pendingContext = null), (n === null || n.child === null) && (Mc(r) ? r.flags |= 4 : n === null || n.memoizedState.isDehydrated && !(r.flags & 256) || (r.flags |= 1024, ja !== null && (Ou(ja), ja = null))), li(n, r), Dt(r), null;
      case 5:
        Sd(r);
        var c = Cu(fo.current);
          ...
          if (n = Cu(gi.current), Mc(r)) {
            ...
            e: {
              ...
              for (d in E) if (E.hasOwnProperty(d)) {
                var T = E[d];
                d === "style" ? ot(n, T) : d === "dangerouslySetInnerHTML" ? (T = T ? T.__html : void 0, T != null && la(n, T)) : d === "children" ? typeof T == "string" ? (l !== "textarea" || T !== "") && ua(n, T) : typeof T == "number" && ua(n, "" + T) : d !== "suppressContentEditableWarning" && d !== "suppressHydrationWarning" && d !== "autoFocus" && (Ye.hasOwnProperty(d) ? T != null && d === "onScroll" && qt("scroll", n) : T != null && lt(n, d, T, m));
              }
              switch (l) {
                case "input":
                  Xn(n), Nn(n, o, !1);
        ...
        if (W = l !== null && l.memoizedState !== null, n.mode & 1 ? (Qn = (U = Qn) || W, br(r, n), Qn = U) : br(r, n), Ti(n), o & 8192) {
          if (U = n.memoizedState !== null, (n.stateNode.isHidden = U) && !W && n.mode & 1) for (ve = n, W = n.child; W !== null; ) {
            for (X = ve = W; ve !== null; ) {
              ...
              ce !== null ? (ce.return = Y, ve = ce) : Do(X);
            }
            W = W.sibling;
          }
          e: for (W = null, X = n; ; ) {
  ...
  function ui(n) {
    return n.mode & 1 ? kt & 2 && Rn !== 0 ? Rn & -Rn : uy.transition !== null ? (Ws === 0 && (Ws = uu()), Ws) : (n = yt, n !== 0 || (n = window.event, n = n === void 0 ? 16 : ls(n.type)), n) : 1;
  }
  function Va(n, r, l, o) {
  ...
  function ku(n, r) {
    ...
    if (r !== 0) {
      ...
      if (r === 6) xi(n, o);
        ...
        if (c = n.current.alternate, !(o & 30) && !hy(c) && (r = No(n, o), r === 2 && (d = di(n), d !== 0 && (o = d, r = Gs(n, d))), r === 1)) throw l = Ps, Il(n, 0), xi(n, o), tn(n, Ft()), l;
  ...
  function rh(n, r, l, o) {
    ...
    if (ts(n, d), n === Cn && (dn = Cn = null, Rn = 0), !(l.subtreeFlags & 2064) && !(l.flags & 2064) || Bl || (Bl = !0, uh(nt, function() {
      return Lo(), null;
      ...
      yt = 1;
      var E = kt;
      kt |= 4, ko.current = null, Ad(n, l), tl(l, n), pu(id), du = !!ad, id = ad = null, n.current = l, vy(l), hr(), kt = E, yt = m, Ea.transition = d;
    } else n.current = l;
...
function SD() {
  ...
  return F.NODE_ENV !== "production" && function() {
    typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u" && typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart == "function" && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(new Error());
    var q = nv(), D = gR(), de = q.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED, Ye = !1;
    function bt(e) {
      Ye = e;
    }
    function De(e) {
    ...
    var Ne = 0, se = 1, Qe = 2, ee = 3, je = 4, ue = 5, Ce = 6, vt = 7, Fn = 8, sn = 9, lt = 10, Ve = 11, Nt = 12, Re = 13, dt = 14, We = 15, xn = 16, gn = 17, Jt = 18, Et = 19, nn = 21, Pe = 22, at = 23, xt = 24, it = 25, B = !0, me = !1, ie = !1, b = !1, $ = !1, Oe = !0, Be = !1, tt = !0, ut = !0, mt = !0, ft = !0, Ct = /* @__PURE__ */ new Set(), Pt = {}, Xn = {};
    function Fr(e, t) {
    ...
    var nt = Object.assign, Ui = 0, Ai, Sl, Pr, Ko, Cr, Jo, Zo;
    function es() {
    }
    ...
    var ji = de.ReactCurrentDispatcher, fi;
    function Oa(e, t, a) {
      {
        if (fi === void 0)
          try {
...
` + i.stack;
    ...
    var Ka = de.ReactDebugCurrentFrame, vn = null, Br = !1;
    function Na() {
      {
        if (vn === null)
          return null;
...
Check the render method of \`` + e + "`." : "";
    ...
    var Rc = {
      ...
      "aria-rowspan": 0,
      "aria-setsize": 0
    }, bl = {}, hs = new RegExp("^(aria)-[" + ke + "]*$"), Jf = new RegExp("^(aria)[A-Z][" + ke + "]*$");
    function Cv(e, t) {
      {
    ...
    var ze = (
      ...
      Te | zn | 0
    ), Wr = Xt | Te | Mt | za | da | mi | kl, ri = Te | Yn | da | kl, Gr = Yr | Mt, tr = Ua | Nl | yi, Su = de.ReactCurrentOwner;
    function Ll(e) {
      var t = e, a = e;
      if (e.alternate)
        for (; t.return; )
    ...
    var pd = D.unstable_scheduleCallback, Mc = D.unstable_cancelCallback, zv = D.unstable_shouldYield, uo = D.unstable_requestPaint, Un = D.unstable_now, uy = D.unstable_getCurrentPriorityLevel, Ml = D.unstable_ImmediatePriority, oo = D.unstable_UserBlockingPriority, zl = D.unstable_NormalPriority, Uv = D.unstable_LowPriority, Ul = D.unstable_IdlePriority, Av = D.unstable_yieldValue, zc = D.unstable_setDisableYieldValue, Xi = null, Dn = null, ae = null, Fa = !1, ha = typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u";
    function vd(e) {
      if (typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ > "u")
        return !1;
    ...
    var Sa = xe, Ri = ai, li = ii, js = Ei, wo = Kt;
    function xr() {
      return wo;
    }
    function Dt(e) {
    ...
    var Rn = de.ReactCurrentBatchConfig, Dr = !0;
    function wu(e) {
      Dr = !!e;
    }
    function Bn() {
    ...
    var Ry = Sn && "TextEvent" in window && !Uu, qd = Sn && (!Gd || Uu && Uu > 8 && Uu <= 11), Xd = 32, qs = String.fromCharCode(Xd);
    function of() {
    ...
    function Fe(e, t, a, i, u, s, f) {
      ...
      if (!(!v && !p)) {
        ...
        if (v) {
          ...
          _ = null, z = a;
        if (_ !== z) {
          var le = Il, Ue = "onMouseLeave", be = "onMouseEnter", _t = "mouse";
          (t === "pointerout" || t === "pointerover") && (le = Ca, Ue = "onPointerLeave", be = "onPointerEnter", _t = "pointer");
          var ht = _ == null ? g : yf(_), O = z == null ? g : yf(z), V = new le(Ue, _t + "leave", _, i, u);
          V.target = ht, V.relatedTarget = O;
          var N = null, K = tc(u);
          if (K === a) {
            var he = new le(be, _t + "enter", z, i, u);
            he.target = O, he.relatedTarget = ht, N = he;
          }
          $R(e, V, N, _, z);
        }
      }
    ...
    function FR(e, t, a, i, u, s, f) {
      jR(e, t, a, i, u, s);
      var p = (s & ry) === 0;
      p && (Fe(e, t, a, i, u), Z(e, t, a, i, u), UR(e, t, a, i, u), Ks(e, t, a, i, u));
    }
...
`).replace(QR, "");
    ...
    function nT(e, t, a, i, u, s, f) {
      ...
      for (var A in a)
        if (a.hasOwnProperty(A)) {
          var H = a[A];
          if (A === Zs)
            typeof H == "string" ? e.textContent !== H && (a[zo] !== !0 && Eh(e.textContent, H, s, f), z = [Zs, H]) : typeof H == "number" && e.textContent !== "" + H && (a[zo] !== !0 && Eh(e.textContent, H, s, f), z = [Zs, "" + H]);
          ...
          typeof p == "boolean") {
            ...
            if (a[zo] !== !0) {
              ...
              A === "value" || A === "checked" || A === "selected")) {
                if (A === rp) {
                  var be = e.innerHTML, _t = H ? H[mh] : void 0;
                  if (_t != null) {
                    var ht = H0(e, _t);
                    ht !== be && ap(A, be, ht);
                  }
                  ...
                  v.delete(A.toLowerCase()), le = Da(e, A, H), H !== le && ap(A, le, H);
                else if (!pn(A, Ue, p) && !Bt(A, H, Ue, p)) {
                  var V = !1;
                  if (Ue !== null)
                    v.delete(Ue.attributeName), le = Xa(e, A, H, Ue);
                  else {
                    var N = i;
                    if (N === Bi && (N = Yf(t)), N === Bi)
    ...
    };
    {
      var iT = ["address", "applet", "area", "article", "aside", "base", "basefont", "bgsound", "blockquote", "body", "br", "button", "caption", "center", "col", "colgroup", "dd", "details", "dir", "div", "dl", "dt", "embed", "fieldset", "figcaption", "figure", "footer", "form", "frame", "frameset", "h1", "h2", "h3", "h4", "h5", "h6", "head", "header", "hgroup", "hr", "html", "iframe", "img", "input", "isindex", "li", "link", "listing", "main", "marquee", "menu", "menuitem", "meta", "nav", "noembed", "noframes", "noscript", "object", "ol", "p", "param", "plaintext", "pre", "script", "section", "select", "source", "style", "summary", "table", "tbody", "td", "template", "textarea", "tfoot", "th", "thead", "title", "tr", "track", "ul", "wbr", "xmp"], P0 = [
        ...
        "desc",
        "title"
      ], lT = P0.concat(["button"]), uT = ["dd", "dt", "li", "option", "optgroup", "p", "rp", "rt"], B0 = {
        current: null,
        formTag: null,
        aTagInScope: null,
    ...
    var Rh = "suppressHydrationWarning", Th = "$", _h = "/$", up = "$?", op = "$!", cT = "style", Hy = null, Vy = null;
    function fT(e) {
    ...
    var By = typeof setTimeout == "function" ? setTimeout : void 0, CT = typeof clearTimeout == "function" ? clearTimeout : void 0, $y = -1, I0 = typeof Promise == "function" ? Promise : void 0, RT = typeof queueMicrotask == "function" ? queueMicrotask : typeof I0 < "u" ? function(e) {
      return I0.resolve(null).then(e).catch(TT);
    } : By;
    function TT(e) {
      setTimeout(function() {
        throw e;
    ...
    function GT(e, t, a, i) {
      return fp(a, e), a.mode & Le, rT(e, t);
    }
    function qT(e, t) {
      fp(t, e);
    }
    ...
    var hf = Math.random().toString(36).slice(2), mf = "__reactFiber$" + hf, Qy = "__reactProps$" + hf, cp = "__reactContainer$" + hf, Wy = "__reactEvents$" + hf, p_ = "__reactListeners$" + hf, v_ = "__reactHandles$" + hf;
    function h_(e) {
      delete e[mf], delete e[Qy], delete e[Wy], delete e[p_], delete e[v_];
    }
    function fp(e, t) {
      t[mf] = e;
    }
    ...
    var q0 = {}, X0 = de.ReactDebugCurrentFrame;
    function Dh(e) {
      if (e) {
    ...
    function Jr(e, t) {
      ...
      t !== kh[Au] && S("Unexpected Fiber popped."), e.current = qy[Au], qy[Au] = null, kh[Au] = null, Au--;
    }
    function Zr(e, t, a) {
      Au++, qy[Au] = e.current, kh[Au] = a, e.current = t;
    }
    var Xy;
    Xy = {};
    var oi = {};
    Object.freeze(oi);
    var ju = Ao(oi), Wl = Ao(!1), Ky = oi;
    function gf(e, t, a) {
      return a && Gl(t) ? Ky : ju.current;
    }
    function K0(e, t, a) {
      {
        var i = e.stateNode;
    ...
    function Lh(e) {
      {
        ...
        return Ky = ju.current, Zr(ju, a, e), Zr(Wl, Wl.current, e), !0;
      }
    }
    function eE(e, t, a) {
      {
    ...
    var jo = 0, Mh = 1, Fu = null, Zy = !1, eg = !1;
    function tE(e) {
    ...
    function rE(e, t, a) {
      ...
      if (v > 30) {
        var y = s - s % 5, g = (1 << y) - 1, w = (f & g).toString(32), _ = f >> y, z = s - y, A = Ah(t) + z, H = p << z, le = H | _, Ue = w + u;
        Hu = 1 << A | le, Vu = Ue;
      } else {
    ...
    function b_(e) {
      ...
      return Di = YT(t), kr = e, il = !0, Ho = null, ic = !1, !0;
    }
    function D_(e, t, a) {
      return Di = QT(t), kr = e, il = !0, Ho = null, ic = !1, a !== null && __(e, a), !0;
    }
    function iE(e, t) {
      switch (e.tag) {
        case ee: {
    ...
    function k_(e, t, a) {
      var i = e.stateNode, u = !ic, s = WT(i, e.type, e.memoizedProps, t, a, e, u);
    ...
    function jh(e) {
      ...
      if (!il)
        return sE(e), il = !0, !1;
      if (e.tag !== ee && (e.tag !== ue || ZT(e.type) && !Py(e.type, e.memoizedProps))) {
        var t = Di;
        if (t)
          if (ag(e))
            cE(e), ig();
      ...
      return sE(e), e.tag === Re ? Di = L_(e) : Di = kr ? sp(e.stateNode) : null, !0;
    }
    function M_() {
      return il && Di !== null;
    }
    ...
    var z_ = de.ReactCurrentBatchConfig, U_ = null;
    function A_() {
...
Please update the following components: %s`, v);
        ...
        if (e.size > 0) {
          var y = lc(e);
          De(`componentWillMount has been renamed, and is not recommended for use. See https://reactjs.org/link/unsafe-component-lifecycles for details.
...
Please update the following components: %s`, y);
        ...
        if (a.size > 0) {
          var g = lc(a);
          De(`componentWillReceiveProps has been renamed, and is not recommended for use. See https://reactjs.org/link/unsafe-component-lifecycles for details.
...
Please update the following components: %s`, g);
        ...
        if (u.size > 0) {
          var w = lc(u);
          De(`componentWillUpdate has been renamed, and is not recommended for use. See https://reactjs.org/link/unsafe-component-lifecycles for details.
...
Learn more about this warning here: https://reactjs.org/link/legacy-context`, u);
    ...
    function Sp(e, t, a) {
      ...
      if (i !== null && typeof i != "function" && typeof i != "object") {
        if ((e.mode & un || tt) && // We warn in ReactElement.js if owner and self are equal for string refs
...
See https://reactjs.org/link/refs-must-have-owner for more information.`);
    ...
    function hE(e) {
      ...
      function v(O, V, N, K) {
        ...
        E1(V, N) || // Lazy types should reconcile their resolved type.
        // We need to do this after the Hot Reloading check above,
        // because hot reloading has different semantics than prod because
        // it doesn't resuspend. So we can't let the call below suspend.
        typeof he == "object" && he !== null && he.$$typeof === Ae && vE(he) === V.type)) {
          var oe = u(V, N.props);
          return oe.ref = Sp(O, V, N), oe.return = O, oe._debugSource = N._source, oe._debugOwner = N._owner, oe;
        }
        var Ie = l0(N, O.mode, K);
        return Ie.ref = Sp(O, V, N), Ie.return = O, Ie;
      }
      function y(O, V, N, K) {
        if (V === null || V.tag !== je || V.stateNode.containerInfo !== N.containerInfo || V.stateNode.implementation !== N.implementation) {
          var he = o0(N, O.mode, K);
          return he.return = O, he;
        } else {
      ...
      function w(O, V, N) {
        ...
        if (typeof V == "object" && V !== null) {
          switch (V.$$typeof) {
            case Er: {
              var he = l0(V, O.mode, N);
              return he.ref = Sp(O, null, V), he.return = O, he;
            }
            case Hr: {
              var oe = o0(V, O.mode, N);
              return oe.return = O, oe;
            }
            case Ae: {
              var Ie = V._payload, Ze = V._init;
              return w(O, Ze(Ie), N);
            }
          }
          if (wt(V) || Vr(V)) {
      ...
      function H(O, V, N, K) {
        for (var he = null, oe = 0; oe < N.length; oe++) {
          var Ie = N[oe];
          he = A(Ie, he, O);
        }
    ...
    function Ih(e, t) {
      ...
      var a = e.alternate;
      a !== null && (a.lanes = rt(a.lanes, t)), a === null && (e.flags & (Xt | mi)) !== ze && m1(e);
      for (var i = e, u = e.return; u !== null; )
        u.childLanes = rt(u.childLanes, t), a = u.alternate, a !== null ? a.childLanes = rt(a.childLanes, t) : (u.flags & (Xt | mi)) !== ze && m1(e), i = u, u = u.return;
      if (i.tag === ee) {
        var s = i.stateNode;
        return s;
      } else
    ...
    function Vo(e, t, a) {
      ...
      if (i === null)
        return null;
      var u = i.shared;
      if (Wh === u && !Eg && (S("An update (setState, replaceState, or forceUpdate) was scheduled from inside an update function. Update functions should be pure, with zero side-effects. Consider using componentDidUpdate or a callback."), Eg = !0), Iw()) {
        var s = u.pending;
    ...
    function qh(e, t, a, i) {
      ...
      if (s !== null) {
        var z = u.baseState, A = I, H = null, le = null, Ue = null, be = s;
        do {
          ...
          if (Vl(i, _t)) {
            ...
            Ue === null ? (le = Ue = O, H = z) : Ue = Ue.next = O, A = rt(A, _t);
          }
        ...
        Ue === null && (H = z), u.baseState = H, u.firstBaseUpdate = le, u.lastBaseUpdate = Ue;
    ...
    function bE(e) {
      Jh(Kh.current);
      var t = Jh(Po.current), a = dT(t, e.type);
      t !== a && (Zr(Cp, e, e), Zr(Po, a, e));
    }
    function xg(e) {
      Cp.current === e && (Jr(Po, e), Jr(Cp, e));
    }
    var q_ = 0, DE = 1, kE = 1, Rp = 2, ul = Ao(q_);
    function wg(e, t) {
      return (e & t) !== 0;
    }
    function bf(e) {
    ...
    var fe = de.ReactCurrentDispatcher, Tp = de.ReactCurrentBatchConfig, Og, kf;
    Og = /* @__PURE__ */ new Set();
    var sc = I, Qt = null, ir = null, lr = null, em = !1, _p = !1, xp = 0, Z_ = 0, ex = 25, P = null, ki = null, $o = -1, Ng = !1;
    function Vt() {
      {
        var e = P;
...
Incoming: %s`, P, "[" + t.join(", ") + "]", "[" + e.join(", ") + "]");
    ...
    function Nf(e, t, a, i, u, s) {
      sc = s, Qt = t, ki = e !== null ? e._debugHookTypes : null, $o = -1, Ng = e !== null && e.type !== t.type, t.memoizedState = null, t.updateQueue = null, t.lanes = I, e !== null && e.memoizedState !== null ? fe.current = KE : ki !== null ? fe.current = XE : fe.current = qE;
      var f = a(i, u);
      if (_p) {
        var p = 0;
        do {
          ...
          p += 1, Ng = !1, ir = null, lr = null, t.updateQueue = null, $o = -1, fe.current = JE, f = a(i, u);
        } while (_p);
      }
    ...
    function OE(e, t, a) {
      t.updateQueue = e.updateQueue, (t.mode & qr) !== re ? t.flags &= ~(gu | Aa | Yr | Te) : t.flags &= ~(Yr | Te), e.lanes = _o(e.lanes, a);
    }
    function NE() {
      if (fe.current = pm, em) {
      ...
      if (f !== null) {
        ...
        do {
          ...
          if (Vl(sc, le)) {
            ...
            A === null ? (z = A = Ue, _ = w) : A = A.next = Ue, Qt.lanes = rt(Qt.lanes, le), Qp(le);
          }
          H = H.next;
        } while (H !== null && H !== g);
    ...
    function jg(e, t, a) {
      ...
      if (f) {
        ...
        if (s = t(), !kf) {
          var p = t();
          we(s, p) || (S("The result of getSnapshot should be cached to avoid an infinite loop"), kf = !0);
        }
        var v = Lm();
        if (v === null)
    ...
    function tm(e, t, a) {
      ...
      if (!kf) {
        var f = t();
        we(s, f) || (S("The result of getSnapshot should be cached to avoid an infinite loop"), kf = !0);
      }
    ...
    function rx(e, t, a) {
      ...
      try {
        ...
        if (Dt(i), Tp.transition = u, u === null && s._updatedFibers) {
          ...
          f > 10 && De("Detected a large number of updates inside startTransition. If this is due to a subscription please re-write it to use React provided hooks. Otherwise concurrent mode guarantees are off the table."), s._updatedFibers.clear();
        }
      }
    }
    function Wg() {
      var e = nm(!1), t = e[0], a = e[1], i = rx.bind(null, a), u = Xl();
    ...
    }, qE = null, XE = null, KE = null, JE = null, Kl = null, ol = null, vm = null;
    {
      ...
      qE = {
        ...
        useCallback: function(e, t) {
          return P = "useCallback", te(), Ig(e, t);
        },
        useContext: function(e) {
        ...
        useCallback: function(e, t) {
          return P = "useCallback", Ke(), te(), cm(e, t);
        },
        useContext: function(e) {
          return P = "useContext", Ke(), te(), qn(e);
        },
        useEffect: function(e, t) {
          return P = "useEffect", Ke(), te(), Dp(e, t);
        },
        useImperativeHandle: function(e, t, a) {
          return P = "useImperativeHandle", Ke(), te(), om(e, t, a);
        },
        useInsertionEffect: function(e, t) {
          return P = "useInsertionEffect", Ke(), te(), lm(e, t);
        },
        useLayoutEffect: function(e, t) {
          return P = "useLayoutEffect", Ke(), te(), um(e, t);
        },
        useMemo: function(e, t) {
          P = "useMemo", Ke(), te();
          var a = fe.current;
        ...
        useDebugValue: function(e, t) {
          return P = "useDebugValue", Ke(), te(), sm();
        },
        useDeferredValue: function(e) {
          return P = "useDeferredValue", Ke(), te(), HE(e);
        },
        useTransition: function() {
          return P = "useTransition", Ke(), te(), BE();
        },
        useMutableSource: function(e, t, a) {
          return P = "useMutableSource", Ke(), te(), void 0;
        },
        useSyncExternalStore: function(e, t, a) {
          return P = "useSyncExternalStore", Ke(), te(), tm(e, t);
        },
        useId: function() {
          return P = "useId", Ke(), te(), dm();
        },
        unstable_isNewReconciler: me
      }, vm = {
        readContext: function(e) {
        ...
        useDeferredValue: function(e) {
          return P = "useDeferredValue", Ke(), te(), VE(e);
        },
        useTransition: function() {
          return P = "useTransition", Ke(), te(), $E();
        },
        useMutableSource: function(e, t, a) {
          return P = "useMutableSource", Ke(), te(), void 0;
        },
...
https://reactjs.org/link/unsafe-component-lifecycles`, le, Ue, z !== null ? `
  ...
  ` + H : ""));
    ...
    function fx(e, t) {
      var a = t.state;
      typeof t.componentWillMount == "function" && t.componentWillMount(), typeof t.UNSAFE_componentWillMount == "function" && t.UNSAFE_componentWillMount(), a !== t.state && (S("%s.componentWillMount(): Assigning directly to this.state is deprecated (except inside a component's constructor). Use setState instead.", Ge(e) || "Component"), fS.enqueueReplaceState(t, t.state, null));
    }
    function sC(e, t, a, i) {
      var u = t.state;
    ...
    function dS(e, t, a, i) {
      ...
      if (typeof v == "function" && (cS(e, t, v, a), u.state = e.memoizedState), typeof t.getDerivedStateFromProps != "function" && typeof u.getSnapshotBeforeUpdate != "function" && (typeof u.UNSAFE_componentWillMount == "function" || typeof u.componentWillMount == "function") && (fx(e, u), qh(e, a, u, i), u.state = e.memoizedState), typeof u.componentDidMount == "function") {
        var y = Te;
    ...
    function px(e, t, a, i, u) {
      ...
      if (qh(t, i, s, u), le = t.memoizedState, f === v && H === le && !Oh() && !Xh() && !ie)
      ...
      var Ue = Xh() || lC(t, a, p, i, H, le, w) || // TODO: In some cases, we'll end up checking if context has changed twice,
      // both before and after `shouldComponentUpdate` has been called. Not ideal,
      // but I'm loath to refactor this function. This only happens for memoized
      // components so it's not that common.
      ie;
      return Ue ? (!A && (typeof s.UNSAFE_componentWillUpdate == "function" || typeof s.componentWillUpdate == "function") && (typeof s.componentWillUpdate == "function" && s.componentWillUpdate(i, le, w), typeof s.UNSAFE_componentWillUpdate == "function" && s.UNSAFE_componentWillUpdate(i, le, w)), typeof s.componentDidUpdate == "function" && (t.flags |= Te), typeof s.getSnapshotBeforeUpdate == "function" && (t.flags |= zn)) : (typeof s.componentDidUpdate == "function" && (f !== e.memoizedProps || H !== e.memoizedState) && (t.flags |= Te), typeof s.getSnapshotBeforeUpdate == "function" && (f !== e.memoizedProps || H !== e.memoizedState) && (t.flags |= zn), t.memoizedProps = i, t.memoizedState = le), s.props = i, s.state = le, s.context = w, Ue;
    }
    function cc(e, t) {
      return {
        value: e,
...
` + ("" + y);
    ...
    function hS(e, t, a) {
      ...
      return f !== null && typeof f.componentDidCatch == "function" && (i.callback = function() {
        C1(e), vS(e, t), typeof u != "function" && ib(this);
        var v = t.value, y = t.stack;
        this.componentDidCatch(v, {
          componentStack: y !== null ? y : ""
        }), typeof u != "function" && (Kr(e.lanes, xe) || S("%s: Error boundaries should implement getDerivedStateFromError(). In that method, return a state update to display an error message or fallback UI.", Ge(e) || "Unknown"));
      }), i;
    }
    function fC(e, t, a) {
      var i = e.pingCache, u;
    ...
    function yx(e, t) {
      var a = e.tag;
      if ((e.mode & Le) === re && (a === Ne || a === Ve || a === We)) {
        var i = e.alternate;
    ...
    function pC(e, t, a, i, u) {
      if ((e.mode & Le) === re) {
        if (e === t)
          ...
          if (e.flags |= Xe, a.flags |= kc, a.flags &= ~(Lv | Ol), a.tag === se) {
            var s = a.alternate;
            if (s === null)
              a.tag = gn;
            else {
    ...
    function gx(e, t, a, i, u) {
      if (a.flags |= Ol, ha && Wp(e, u), i !== null && typeof i == "object" && typeof i.then == "function") {
        var s = i;
        yx(a), Or() && a.mode & Le && aE();
        var f = dC(t);
        if (f !== null) {
          f.flags &= ~Rr, pC(f, t, a, e, u), f.mode & Le && fC(e, s, u), mx(f, e, s);
          return;
        } else {
          if (!bd(u)) {
            fC(e, s, u), GS();
        ...
        var v = dC(t);
        if (v !== null) {
          (v.flags & er) === ze && (v.flags |= Rr), pC(v, t, a, e, u), ug(cc(i, a));
          return;
        }
      }
      i = cc(i, a), Kw(i);
      ...
      do {
        switch (y.tag) {
          ...
          case se:
            ...
            if ((y.flags & Xe) === ze && (typeof A.getDerivedStateFromError == "function" || H !== null && typeof H.componentDidCatch == "function" && !d1(H))) {
              y.flags |= er;
              var le = To(u);
    ...
    var Np = de.ReactCurrentOwner, cl = !1, mS, Lp, yS, gS, SS, fc, ES, Em, Mp;
    ...
    function vC(e, t, a, i, u) {
      ...
      return ya(), e !== null && !cl ? (OE(e, t, u), Bu(e, t, u)) : (Or() && y && tg(t), t.flags |= ni, Ra(e, t, v, u), t.child);
    }
    function hC(e, t, a, i, u) {
      if (e === null) {
        ...
        a.defaultProps === void 0) {
          var f = s;
          return f = Vf(s), t.tag = We, t.type = f, TS(t, s), mC(e, t, f, i, u);
        }
        {
          var p = s.propTypes;
          if (p && al(
    ...
    function SC(e, t, a, i, u) {
      ...
      var A = t.stateNode, H;
      A === null ? (Rm(e, t), oC(t, a, i), dS(t, a, i, u), H = !0) : e === null ? H = dx(t, a, i, u) : H = px(e, t, a, i, u);
      var le = RS(e, t, a, H, z, u);
      {
        var Ue = t.stateNode;
        H && Ue.props !== i && (fc || S("It looks like %s is reassigning its own `this.props` while rendering. This is not supported and can lead to confusing bugs.", Ge(t) || "a component"), fc = !0);
      }
      return le;
    }
    function RS(e, t, a, i, u, s) {
      ...
      return t.flags |= ni, e !== null && f ? Ex(e, t, v, s) : Ra(e, t, v, s), t.memoizedState = p.state, u && eE(t, a, !0), t.child;
    }
    function EC(e) {
      var t = e.stateNode;
    ...
    function Dx(e, t, a, i, u) {
      Rm(e, t), t.tag = se;
      var s;
      return Gl(a) ? (s = !0, Lh(t)) : s = !1, xf(t, u), oC(t, a, i), dS(t, a, i, u), RS(null, t, a, !0, s, u);
    }
    function kx(e, t, a, i) {
      Rm(e, t);
      ...
      if (
        ...
        var _ = !1;
        return Gl(a) ? (_ = !0, Lh(t)) : _ = !1, t.memoizedState = p.state !== null && p.state !== void 0 ? p.state : null, Cg(t), uC(t, p), dS(t, a, u, i), RS(null, t, a, !0, _, i);
      } else {
...
Check the render method of \`` + i + "`.");
    ...
    function RC(e, t, a) {
      ...
      if (f || Nx(u, e) ? (s = !0, t.flags &= ~Xe) : (e === null || e.memoizedState !== null) && (u = X_(u, kE)), u = bf(u), Bo(t, u), e === null) {
        lg(t);
        ...
        if (s) {
          var H = i.fallback, le = i.children, Ue = Ux(e, t, le, H, a), be = t.child, _t = e.child.memoizedState;
          return be.memoizedState = _t === null ? xS(a) : Ox(_t, a), be.childLanes = Lx(e, a), t.memoizedState = _S, Ue;
        } else {
    ...
    function Mx(e, t, a, i) {
      ...
      return (u & Le) === re && s !== null ? (p = s, p.childLanes = I, p.pendingProps = f, e.mode & qe && (p.actualDuration = 0, p.actualStartTime = -1, p.selfBaseDuration = 0, p.treeBaseDuration = 0), v = Xo(a, u, i, null)) : (p = bS(f, u), v = Xo(a, u, i, null)), p.return = e, v.return = e, p.sibling = v, e.child = p, v;
    }
    function bS(e, t, a) {
    ...
    function jx(e, t, a) {
      return (e.mode & Le) === re ? (S("Cannot hydrate Suspense in legacy mode. Switch from ReactDOM.hydrate(element, container) to ReactDOMClient.hydrateRoot(container, <App />).render(element) or remove the Suspense components from the server rendered components."), e.lanes = xe) : Yy(t) ? e.lanes = Zi : e.lanes = ga, null;
    }
    function Fx(e, t, a, i, u, s, f) {
      if (a)
        if (t.flags & Rr) {
          ...
          var V = i.children, N = i.fallback, K = Ax(e, t, V, N, f), he = t.child;
          return he.memoizedState = xS(f), t.memoizedState = _S, K;
        }
      else {
        if (x_(), (t.mode & Le) === re)
          return Cm(
    ...
    function Bu(e, t, a) {
      return e !== null && (t.dependencies = e.dependencies), rC(), Qp(t.lanes), Kr(a, t.childLanes) ? (H_(e, t), t.child) : null;
    }
    function Wx(e, t, a) {
      {
        var i = t.return;
    ...
    function kC(e, t, a) {
      if (t._debugNeedsRemount && e !== null)
        return Wx(e, t, i0(t.type, t.key, t.pendingProps, t._debugOwner || null, t.mode, t.lanes));
      if (e !== null) {
      ...
      switch (t.lanes = I, t.tag) {
        ...
        case je:
          return Ix(e, t, a);
        case Ve: {
          var H = t.type, le = t.pendingProps, Ue = t.elementType === H ? le : sl(H, le);
          return vC(e, t, H, Ue, a);
        }
        case vt:
          return Cx(e, t, a);
        case Fn:
        ...
        case dt: {
          ...
          return ht = sl(be.type, ht), hC(e, t, be, ht, a);
        }
        case We:
    ...
    NC = function(e, t, a, i) {
      ...
      if (s !== i) {
        var f = t.stateNode, p = _g(), v = gT(f, a, s, i, u, p);
    ...
    function qx(e, t, a) {
      if (M_() && (t.mode & Le) !== re && (t.flags & Xe) === ze)
      ...
      if (a !== null && a.dehydrated !== null)
        if (e === null) {
          ...
          if (Rf(), (t.flags & Xe) === ze && (t.memoizedState = null), t.flags |= Te, Lr(t), (t.mode & qe) !== re) {
            var f = a !== null;
            if (f) {
              var p = t.child;
    ...
    function zC(e, t, a) {
      ...
      switch (ng(t), t.tag) {
        ...
        case ue: {
          ...
          if (e !== null && t.stateNode != null)
            ...
            if (w)
              ...
              var _ = hT(y, i, v, g, t);
              NC(_, t, !1, !1), t.stateNode = _, yT(_, y, i, v) && Mf(t);
            }
            t.ref !== null && OC(t);
          }
          return Lr(t), null;
        ...
        case Ce: {
          ...
          if (e && t.stateNode != null) {
            ...
            if (typeof z != "string" && t.stateNode === null)
              throw new Error("We must have new props for new mounts. This error is likely caused by a bug in React. Please file an issue.");
            var H = wE(), le = _g(), Ue = jh(t);
            Ue ? O_(t) && Mf(t) : t.stateNode = ST(z, H, le, t);
          }
          return Lr(t), null;
        }
        case Re: {
          ...
          if ((t.flags & Xe) !== ze)
            return t.lanes = a, (t.mode & qe) !== re && eS(t), t;
          ...
          if (ht !== O && ht) {
            ...
            if (V.flags |= kl, (t.mode & Le) !== re) {
              ...
              N || wg(ul.current, kE) ? Xw() : GS();
            }
          }
          var K = t.updateQueue;
          if (K !== null && (t.flags |= Te), Lr(t), (t.mode & qe) !== re && ht) {
            var he = t.child;
        ...
        case je:
          return wf(t), OS(e, t), e === null && d_(t.stateNode.containerInfo), Lr(t), null;
        case lt:
              ...
              if (!$n)
                for (var Ut = t.child; Ut !== null; ) {
                  ...
                  if (jn !== null) {
                    ...
                    return ta !== null && (t.updateQueue = ta, t.flags |= Te), t.subtreeFlags = ze, V_(t, a), Bo(t, bg(ul.current, Rp)), t.child;
                  }
                  Ut = Ut.sibling;
                }
        ...
        case at: {
          ...
          return !Pf || (t.mode & Le) === re ? Lr(t) : Kr(tu, ga) && (Lr(t), t.subtreeFlags & (Xt | Te) && (t.flags |= kl)), null;
        }
        case xt:
          return null;
        case it:
    ...
    function Xx(e, t, a) {
      switch (ng(t), t.tag) {
        case se: {
          ...
          Gl(i) && Nh(t);
          var u = t.flags;
          return u & er ? (t.flags = u & ~er | Xe, (t.mode & qe) !== re && eS(t), t) : null;
        }
        case ee: {
        ...
        case Re: {
          ...
          var p = t.flags;
          return p & er ? (t.flags = p & ~er | Xe, (t.mode & qe) !== re && eS(t), t) : null;
        }
        case Et:
          return Df(t), null;
        case je:
    ...
    var AC = null;
    AC = /* @__PURE__ */ new Set();
    var Tm = !1, Mr = !1, Kx = typeof WeakSet == "function" ? WeakSet : Set, ge = null, zf = null, Uf = null;
    function Jx(e) {
      ti(null, function() {
        throw e;
      }), Gi();
    ...
    function nw() {
      for (; ge !== null; ) {
        var e = ge, t = e.child;
        (e.subtreeFlags & Qr) !== ze && t !== null ? (t.return = e, ge = t) : rw();
      }
    }
    function rw() {
      for (; ge !== null; ) {
...
Learn more about data fetching with Hooks: https://reactjs.org/link/hooks-data-fetching` : y = " You returned: " + p, S("%s must not return anything besides a function, which is used for clean-up.%s", v, y);
    ...
    function lw(e, t, a, i) {
      if ((a.flags & ri) !== ze)
        switch (a.tag) {
          ...
          case Nt: {
            {
              var z = a.memoizedProps, A = z.onCommit, H = z.onRender, le = a.stateNode.effectDuration, Ue = tC(), be = t === null ? "mount" : "update";
              eC() && (be = "nested-update"), typeof H == "function" && H(a.memoizedProps.id, be, a.actualDuration, a.treeBaseDuration, a.actualStartTime, Ue);
              {
                typeof A == "function" && A(a.memoizedProps.id, be, le, Ue), rb(a);
                var _t = a.return;
                e: for (; _t !== null; ) {
                  switch (_t.tag) {
                    case ee:
    ...
    function uw(e) {
      switch (e.tag) {
        ...
        case se: {
          var t = e.stateNode;
          typeof t.componentDidMount == "function" && ew(e, e.return, t), FC(e, e.return);
          break;
        }
        case ue: {
          FC(e, e.return);
    ...
    function IC(e, t, a) {
      switch (hd(a), a.tag) {
        ...
        case Ce: {
          {
            var i = zr, u = dl;
            zr = null, Qo(e, t, a), zr = i, dl = u, zr !== null && (dl ? LT(zr, a.stateNode) : NT(zr, a.stateNode));
          }
          return;
        }
        case Jt: {
          zr !== null && (dl ? MT(zr, a.stateNode) : Iy(zr, a.stateNode));
          return;
        }
        case je: {
          {
    ...
    function QC(e, t, a) {
      ...
      switch (e.tag) {
        ...
        case Re: {
          ...
          var H = e.child;
          if (H.flags & kl) {
            var le = H.stateNode, Ue = H.memoizedState, be = Ue !== null;
        ...
        case Pe: {
          ...
          if (eu(e), u & kl) {
            ...
            if (V.isHidden = K, K && !ht && (he.mode & Le) !== re) {
              ge = he;
    ...
    function Ew(e, t, a, i) {
      for (; ge !== null; ) {
        var u = ge, s = u.child;
        (u.subtreeFlags & Gr) !== ze && s !== null ? (s.return = u, ge = s) : Cw(e, t, a, i);
      }
    }
    function Cw(e, t, a, i) {
      for (; ge !== null; ) {
    ...
    function _w() {
      for (; ge !== null; ) {
        ...
        (e.subtreeFlags & Gr) !== ze && t !== null ? (t.return = e, ge = t) : xw();
      }
    }
    function xw() {
      for (; ge !== null; ) {
        var e = ge;
        (e.flags & Yr) !== ze && (hn(e), ww(e), rn());
        var t = e.sibling;
        if (t !== null) {
          t.return = e.return, ge = t;
          return;
    ...
    function ww(e) {
      switch (e.tag) {
        ...
        case Ve:
        case We: {
          e.mode & qe ? (Zg(), fl(Nr | rr, e, e.return), Jg(e)) : fl(Nr | rr, e, e.return);
          break;
        }
      }
    }
    ...
    function kw(e, t) {
      switch (e.tag) {
        ...
        case Ve:
        case We: {
          e.mode & qe ? (Zg(), fl(Nr, e, t), Jg(e)) : fl(Nr, e, t);
          break;
        }
      }
    }
    ...
    var Aw = de.ReactCurrentActQueue;
    function jw(e) {
      {
        var t = (
    ...
    var Fw = Math.ceil, US = de.ReactCurrentDispatcher, AS = de.ReactCurrentOwner, Ur = de.ReactCurrentBatchConfig, vl = de.ReactCurrentActQueue, ur = (
      /*             */
      0
    ), KC = (
      /*               */
      ...
      /*                */
      4
    ), $u = 0, jp = 1, dc = 2, xm = 3, Fp = 4, JC = 5, jS = 6, Tt = ur, Ta = null, On = null, or = I, tu = I, FS = Ao(I), sr = $u, Hp = null, wm = I, Vp = I, bm = I, Pp = null, Ia = null, HS = 0, ZC = 500, e1 = 1 / 0, Hw = 500, Iu = null;
    function Bp() {
      e1 = Un() + Hw;
    }
    function t1() {
    ...
    var Dm = !1, VS = null, jf = null, pc = !1, Wo = null, $p = I, PS = [], BS = null, Vw = 50, Ip = 0, $S = null, IS = !1, km = !1, Pw = 50, Ff = 0, Om = null, Yp = en, Nm = I, n1 = !1;
    function Lm() {
      return Ta;
    }
    function _a() {
    ...
    function Bw(e) {
      var t = e.mode;
      return (t & Le) === re ? xe : _r();
    }
    function cr(e, t, a, i) {
      db(), n1 && S("useInsertionEffect must not schedule updates."), IS && (km = !0), xo(e, a, i), (Tt & Ar) !== I && e === Ta ? hb(t) : (ha && zd(e, t, a), mb(t), e === Ta && ((Tt & Ar) === ur && (Vp = rt(Vp, a)), sr === Fp && qo(e, or)), Ya(e, i), a === xe && Tt === ur && (t.mode & Le) === re && // Treat `act` as if it's inside `batchedUpdates`, even in legacy mode.
    ...
    function Ya(e, t) {
      ...
      var f;
      if (u === xe)
        e.tag === jo ? (vl.isBatchingLegacy !== null && (vl.didScheduleLegacyUpdate = !0), g_(i1.bind(null, e))) : tE(i1.bind(null, e)), vl.current !== null ? vl.current.push(Fo) : RT(function() {
          (Tt & (Ar | Ni)) === ur && Fo();
        }), f = null;
      else {
        var p;
    ...
    function r1(e, t) {
      ...
      if (u === I)
        return null;
      var s = !Ms(e, u) && !Yv(e, u) && !t, f = s ? eb(e, u) : zm(e, u);
      if (f !== $u) {
        if (f === dc) {
          var p = Ls(e);
          p !== I && (u = p, f = YS(e, p));
      ...
      switch (t) {
        ...
        case xm: {
          ...
          !S1()) {
            ...
            if (i > 10) {
              ...
              e.timeoutHandle = By(hc.bind(null, e, Ia, Iu), i);
              break;
            }
          }
          hc(e, Ia, Iu);
        ...
        case Fp: {
          if (qo(e, a), Iv(a))
            break;
          if (!S1()) {
            var f = Pv(e, a), p = f, v = Un() - p, y = fb(v) - v;
            if (y > 10) {
              e.timeoutHandle = By(hc.bind(null, e, Ia, Iu), y);
              break;
            }
          }
          hc(e, Ia, Iu);
    ...
    function Ww(e, t) {
      t !== I && (Jc(e, rt(t, xe)), Ya(e, Un()), (Tt & (Ar | Ni)) === ur && (Bp(), Fo()));
    }
    function QS(e, t) {
      var a = Tt;
      Tt |= KC;
    ...
    function vc(e, t) {
      ...
      if (a !== $y && (e.timeoutHandle = $y, CT(a)), On !== null)
      ...
      return On = s, or = tu = t, sr = $u, Hp = null, wm = I, Vp = I, bm = I, Pp = null, Ia = null, $_(), ll.discardPendingWarnings(), s;
    }
    function u1(e, t) {
      do {
        var a = On;
    ...
    function c1(e) {
      ...
      hn(e);
      var a;
      (e.mode & qe) !== re ? (Kg(e), a = qS(t, e, tu), gm(e, !0)) : a = qS(t, e, tu), rn(), e.memoizedProps = e.pendingProps, a === null ? f1(e) : On = a, AS.current = null;
    }
    function f1(e) {
      var t = e;
      do {
        ...
        if ((t.flags & Ol) === ze) {
          hn(t);
          var u = void 0;
          if ((t.mode & qe) === re ? u = zC(a, t, tu) : (Kg(t), u = zC(a, t, tu), gm(t, !1)), rn(), u !== null) {
            On = u;
            return;
          }
        } else {
    ...
    function hc(e, t, a) {
      ...
      try {
        Ur.transition = null, Dt(Sa), nb(e, t, a, i);
      } finally {
    ...
    function nb(e, t, a, i) {
      ...
      fy(e, f), e === Ta && (Ta = null, On = null, or = I), ((u.subtreeFlags & Gr) !== ze || (u.flags & Gr) !== ze) && (pc || (pc = !0, BS = a, JS(zl, function() {
        return Qu(), null;
      })));
      ...
      if (p || v) {
        ...
        Dt(Sa);
        var w = Tt;
        Tt |= Ni, AS.current = null, tw(e, u), nC(), hw(e, u, s), vT(e.containerInfo), e.current = u, po(s), mw(u, e, s), Hv(), uo(), Tt = w, Dt(g), Ur.transition = y;
      } else
        e.current = u, nC();
      var _ = pc;
      if (pc ? (pc = !1, Wo = e, $p = s) : (Ff = 0, Om = null), f = e.pendingLanes, f === I && (jf = null), _ || h1(e.current, !1), Ha(u.stateNode, i), ha && e.memoizedUpdaters.clear(), Uw(), Ya(e, Un()), t !== null)
        for (var z = e.onRecoverableError, A = 0; A < t.length; A++) {
          var H = t[A], le = H.stack, Ue = H.digest;
          z(H.value, {
            componentStack: le,
            digest: Ue
          });
      ...
      return Kr($p, xe) && e.tag !== jo && Qu(), f = e.pendingLanes, Kr(f, xe) ? (ux(), e === $S ? Ip++ : (Ip = 0, $S = e)) : Ip = 0, Fo(), yd(), null;
    }
    function Qu() {
      if (Wo !== null) {
        var e = Wv($p), t = Zc(li, e), a = Ur.transition, i = xr();
        try {
          return Ur.transition = null, Dt(t), ab();
        } finally {
    ...
    function rb(e) {
      PS.push(e), pc || (pc = !0, JS(zl, function() {
        return Qu(), null;
      }));
    }
    function ab() {
      ...
      mn(), h1(t.current, !0), Tt = i, Fo(), km ? t === Om ? Ff++ : (Ff = 0, Om = t) : Ff = 0, IS = !1, km = !1, Eu(t);
      {
    ...
    var ub = lb;
    function p1(e, t, a) {
      var i = cc(a, t), u = cC(e, i, xe), s = Vo(e, u, xe), f = _a();
      s !== null && (xo(s, xe, f), Ya(s, f));
    }
    function on(e, t, a) {
      if (Jx(a), Gp(!1), e.tag === ee) {
        p1(e, e, a);
        return;
      }
      var i = null;
      for (i = t; i !== null; ) {
        if (i.tag === ee) {
          ...
          if (typeof u.getDerivedStateFromError == "function" || typeof s.componentDidCatch == "function" && !d1(s)) {
            var f = cc(a, e), p = hS(i, f, xe), v = Vo(i, p, xe), y = _a();
...
%s`, a);
    ...
    function ob(e, t, a) {
      ...
      i !== null && i.delete(t);
      var u = _a();
      Us(e, a), yb(e), Ta === e && Vl(or, a) && (sr === Fp || sr === xm && kd(or) && Un() - HS < ZC ? vc(e, I) : bm = rt(bm, a)), Ya(e, u);
    }
    function v1(e, t) {
      t === Kt && (t = Bw(e));
      var a = _a(), i = Ba(e, t);
    ...
    function db() {
      ...
      Ff > Pw && (Ff = 0, Om = null, S("Maximum update depth exceeded. This can happen when a component calls setState inside useEffect, but useEffect either doesn't have a dependency array, or one of the dependencies changes on every render."));
    }
    function pb() {
      ll.flushLegacyContextWarning(), ll.flushPendingUnsafeLifecycleWarnings();
    }
    function h1(e, t) {
      hn(e), Um(e, Aa, Lw), t && Um(e, gu, Mw), Um(e, Aa, Ow), t && Um(e, gu, Nw), rn();
    }
    function Um(e, t, a) {
    ...
    function m1(e) {
      {
        if ((Tt & Ar) !== ur || !(e.mode & Le))
          return;
        var t = e.tag;
        if (t !== Qe && t !== ee && t !== se && t !== Ne && t !== Ve && t !== dt && t !== We)
          return;
      ...
      qS = function(e, t, a) {
        ...
        try {
          ...
          if (w_() || s !== null && typeof s == "object" && typeof s.then == "function")
            throw s;
          if ($h(), NE(), UC(e, t), _1(t, i), t.mode & qe && Kg(t), ti(null, kC, null, e, t, a), ly()) {
            var u = Gi();
    ...
    function mb(e) {
      {
        if (e.mode & Le) {
          if (!XC())
            return;
        } else if (!jw() || Tt !== ur || e.tag !== Ne && e.tag !== Ve && e.tag !== We)
          return;
        if (vl.current === null) {
          var t = vn;
          try {
...
This ensures that you're testing the behavior the user would see in the browser. Learn more at https://reactjs.org/link/wrap-tests-with-act`);
    ...
    var Li = null, Hf = null, gb = function(e) {
      Li = e;
    };
    function Vf(e) {
      {
    ...
    function t0(e, t, a) {
      {
        ...
        if (v !== null) {
          var w = Li(v);
          w !== void 0 && (a.has(w) ? g = !0 : t.has(w) && (f === se ? g = !0 : y = !0));
        }
    ...
    function n0(e, t, a) {
      {
        ...
        var v = !1;
        p !== null && t.has(p) && (v = !0), v ? Rb(e, a) : i !== null && n0(i, t, a), u !== null && n0(u, t, a);
      }
    }
    function Rb(e, t) {
      {
    ...
    function _b(e, t, a, i) {
      this.tag = e, this.key = a, this.elementType = null, this.type = null, this.stateNode = null, this.return = null, this.child = null, this.sibling = null, this.index = 0, this.ref = null, this.pendingProps = t, this.memoizedProps = null, this.updateQueue = null, this.memoizedState = null, this.dependencies = null, this.mode = i, this.flags = ze, this.subtreeFlags = ze, this.deletions = null, this.lanes = I, this.childLanes = I, this.alternate = null, this.actualDuration = Number.NaN, this.actualStartTime = Number.NaN, this.selfBaseDuration = Number.NaN, this.treeBaseDuration = Number.NaN, this.actualDuration = 0, this.actualStartTime = -1, this.selfBaseDuration = 0, this.treeBaseDuration = 0, this._debugSource = null, this._debugOwner = null, this._debugNeedsRemount = !1, this._debugHookTypes = null, !r0 && typeof Object.preventExtensions == "function" && Object.preventExtensions(this);
    }
...
Check the render method of %s.`, Ge(vn) || "Unknown"));
      ...
      var B1 = function(e, t, a) {
        ...
        if (t.length !== a.length) {
          ...
          for (var i = 0; i < a.length - 1; i++)
            if (t[i] !== a[i]) {
              De("copyWithRename() expects paths to be the same except for the deepest key");
              return;
            }
        return I1(e, t, a, 0);
      }, Q1 = function(e, t, a, i) {
    ...
    function Qb(e, t) {
      ...
      q1(e);
      var a = !1, i = !1, u = "", s = G1;
      t != null && (t.hydrate ? De("hydrate through createRoot is deprecated. Use ReactDOMClient.hydrateRoot(container, <App />) instead.") : typeof t == "object" && t !== null && t.$$typeof === Er && S(`You passed a JSX element to createRoot. You probably meant to call root.render instead. Example usage:
  ...
  root.render(<App />);`), t.unstable_strictMode === !0 && (a = !0), t.identifierPrefix !== void 0 && (u = t.identifierPrefix), t.onRecoverableError !== void 0 && (s = t.onRecoverableError), t.transitionCallbacks !== void 0 && t.transitionCallbacks);
    ...
    Fm.prototype.unstable_scheduleHydration = Wb;
    function Gb(e, t, a) {
      if (!Hm(e))
    ...
    var qb = de.ReactCurrentOwner, X1;
    X1 = function(e) {
    ...
    function Vm(e, t, a, i, u) {
      X1(a), Kb(u === void 0 ? null : u, "render");
    ...
    Ud(jb), Fs(Fb), jd(Hb), qv(xr), Vd(dy), (typeof Map != "function" || // $FlowIssue Flow incorrectly thinks Map has no prototype
    Map.prototype == null || typeof Map.prototype.forEach != "function" || typeof Set != "function" || // $FlowIssue Flow incorrectly thinks Set has no prototype
    Set.prototype == null || typeof Set.prototype.clear != "function" || typeof Set.prototype.forEach != "function") && S("React depends on Map and Set built-in types. Make sure that you load a polyfill in older browsers. https://reactjs.org/link/react-polyfills"), td(aT), bc(QS, Gw, Yu);
    function rD(e, t) {
    ...
    var m0 = {
      ...
      Events: [Uo, yf, bh, io, hu, QS]
    };
    function iD(e, t) {
      return m0.usingClientEntryPoint || S('You are importing createRoot from "react-dom" which is not supported. You should instead import it from "react-dom/client".'), Qb(e, t);
    }
    function lD(e, t, a) {
      return m0.usingClientEntryPoint || S('You are importing hydrateRoot from "react-dom" which is not supported. You should instead import it from "react-dom/client".'), Gb(e, t, a);
    }
    function uD(e) {
...
You might need to use a local HTTP server (instead of file://): https://reactjs.org/link/react-devtools-faq` : ""), "font-weight:bold");
    ...
    Wa.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = m0, Wa.createPortal = rD, Wa.createRoot = iD, Wa.findDOMNode = Jb, Wa.flushSync = uD, Wa.hydrate = Zb, Wa.hydrateRoot = lD, Wa.render = eD, Wa.unmountComponentAtNode = nD, Wa.unstable_batchedUpdates = QS, Wa.unstable_renderSubtreeIntoContainer = aD, Wa.version = s0, typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u" && typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop == "function" && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop(new Error());
  }(), Wa;
}
var dR;
function ED() {
  ...
  return F.NODE_ENV === "production" ? (q(), $m.exports = gD()) : $m.exports = SD(), $m.exports;
}
var pR;
function CD() {
  if (pR) return Bf;
  ...
  if (F.NODE_ENV === "production")
    ...
    Bf.createRoot = function(de, Ye) {
      D.usingClientEntryPoint = !0;
      try {
        return q.createRoot(de, Ye);
      } finally {
        D.usingClientEntryPoint = !1;
      }
    }, Bf.hydrateRoot = function(de, Ye, bt) {
      D.usingClientEntryPoint = !0;
      try {
        return q.hydrateRoot(de, Ye, bt);
      } finally {
        D.usingClientEntryPoint = !1;
      }
    };
...
function SR(F) {
  var q, D, de = "";
  if (typeof F == "string" || typeof F == "number") de += F;
  else if (typeof F == "object") if (Array.isArray(F)) {
    var Ye = F.length;
    for (q = 0; q < Ye; q++) F[q] && (D = SR(F[q])) && (de && (de += " "), de += D);
  } else for (D in F) F[D] && (de && (de += " "), de += D);
  return de;
}
function yc() {
  for (var F, q, D = 0, de = "", Ye = arguments.length; D < Ye; D++) (F = arguments[D]) && (q = SR(F)) && (de && (de += " "), de += q);
  return de;
}
const TD = "_label_cys8o_1", _D = "_error_cys8o_10", vR = {
  label: TD,
  error: _D
}, ER = (F) => {
  const { className: q, title: D, value: de, error: Ye } = F;
  return /* @__PURE__ */ et.jsxs("label", { className: yc(vR.label, { [vR.error]: Ye }, q), children: [
    /* @__PURE__ */ et.jsx("span", { children: D }),
    de && /* @__PURE__ */ et.jsx("span", { children: de })
  ] });
}, xD = "_root_gnghl_1", wD = "_label_gnghl_5", bD = "_description_gnghl_9", DD = "_top_gnghl_15", kD = "_bottom_gnghl_19", OD = "_input_gnghl_24", ND = "_error_gnghl_41", LD = "_hasRight_gnghl_46", MD = "_right_gnghl_50", zD = "_tooltip_gnghl_63", hl = {
  root: xD,
  label: wD,
  description: bD,
  top: DD,
  ...
  var q;
  const { className: D, right: de, label: Ye, descriptionTop: bt, descriptionBottom: De, error: S, onFocus: Je, ...Ne } = F, se = S0.useRef(null), Qe = (ee) => {
  ...
  return /* @__PURE__ */ et.jsxs(
    "div",
    {
      ...
      style: {
        "--right-width": `${((q = se.current) == null ? void 0 : q.clientWidth) ?? 0}px`
      },
      children: [
        /* @__PURE__ */ et.jsx(ER, { className: hl.label, title: Ye, error: S }),
        /* @__PURE__ */ et.jsx("p", { className: yc(hl.description, hl.top), children: bt }),
        /* @__PURE__ */ et.jsx(
          "input",
          {
        ...
        de && /* @__PURE__ */ et.jsx("div", { ref: se, className: hl.right, children: "%" }),
        /* @__PURE__ */ et.jsx("p", { className: yc(hl.description, hl.bottom), children: De }),
        S ? /* @__PURE__ */ et.jsx("div", { className: hl.tooltip, children: S }) : null
      ]
    }
  );
}, AD = "_section_13pv1_1", jD = "_title_13pv1_8", hR = {
  section: AD,
  title: jD
}, CR = (F) => {
  const { children: q, className: D, title: de } = F;
  return /* @__PURE__ */ et.jsxs("div", { className: yc(hR.section, D), children: [
    /* @__PURE__ */ et.jsx("h4", { className: hR.title, children: de }),
    /* @__PURE__ */ et.jsx("div", { children: q })
  ] });
}, FD = "_root_avgz1_1", HD = "_label_avgz1_7", VD = "_description_avgz1_11", PD = "_inputContainer_avgz1_19", BD = "_input_avgz1_19", $D = "_controlContainer_avgz1_62", ID = "_controlRail_avgz1_68", YD = "_controlRailInner_avgz1_78", QD = "_controlItem_avgz1_86", WD = "_minMax_avgz1_122", ru = {
  root: FD,
  label: HD,
  description: VD,
  inputContainer: PD,
  ...
  const { min: q = 0, max: D = 100, value: de, label: Ye, labelValue: bt, description: De, ...S } = F, Je = (Number(de) - Number(q)) / (Number(D) - Number(q)) * 100;
  return /* @__PURE__ */ et.jsxs("div", { className: ru.root, children: [
    /* @__PURE__ */ et.jsx(ER, { className: ru.label, title: Ye, value: bt }),
    De && /* @__PURE__ */ et.jsx("p", { className: ru.description, children: De }),
    /* @__PURE__ */ et.jsx("div", { className: ru.inputContainer, children: /* @__PURE__ */ et.jsx("input", { className: ru.input, min: q, max: D, value: de, type: "range", ...S }) }),
    /* @__PURE__ */ et.jsxs("div", { className: ru.controlContainer, children: [
      /* @__PURE__ */ et.jsx("div", { className: ru.controlItem, style: { left: `${Je}%` }, "data-label": de }),
      /* @__PURE__ */ et.jsx("div", { className: ru.controlRail, children: /* @__PURE__ */ et.jsx("div", { style: { left: "0", right: `${100 - Je}%` }, className: ru.controlRailInner }) })
    ] }),
    /* @__PURE__ */ et.jsxs("div", { className: ru.minMax, children: [
  ...
  var q;
  const { title: D, tableData: de, resultData: Ye, className: bt } = F;
  return /* @__PURE__ */ et.jsxs(CR, { className: bt, title: D, children: [
    /* @__PURE__ */ et.jsxs("div", { className: ev.table, children: [
      /* @__PURE__ */ et.jsx("div", { className: ev.tableHead, children: de.headers.map((De) => /* @__PURE__ */ et.jsx("span", { children: De }, De)) }),
      (q = de.data) == null ? void 0 : q.map((De) => /* @__PURE__ */ et.jsxs("div", { className: ev.tableItem, children: [
        /* @__PURE__ */ et.jsx("span", { children: De.label }),
        /* @__PURE__ */ et.jsx("span", { children: De.value })
      ] }, De.label))
    ] }),
    /* @__PURE__ */ et.jsx("div", { className: ev.footer, children: Ye.map((De) => /* @__PURE__ */ et.jsxs("div", { className: ev.footerItem, children: [
      /* @__PURE__ */ et.jsx("span", { children: De.label }),
      /* @__PURE__ */ et.jsx("span", { children: De.value })
    ] }, De.label)) })
  ] });
...
}, tk = ek["tofu-widget"], nk = "_widget_17eig_1", rk = "_section_17eig_9", ak = "_title_17eig_14", mR = {
  widget: nk,
  section: rk,
  title: ak
}, yR = new Intl.NumberFormat("en-US", {
  style: "currency",
  currency: "USD"
}), ik = () => {
  const [F, q] = S0.useState({
    yearlyGrossIncome: 0,
    federalTax: 0,
    stateTax: 0,
    socialSecurity: 0,
    ...
    const Je = Number(S.target.value) > 0 ? Number(S.target.value) : 0;
    q({
      ...F,
      [S.target.name]: Je
    });
  }, de = F.federalTax + F.stateTax + F.socialSecurity + F.medicare, Ye = F.yearlyGrossIncome ? F.yearlyGrossIncome / 100 * de : 0, bt = F.yearlyGrossIncome - Ye, De = F.yearlyGrossIncome > 1e7;
  return /* @__PURE__ */ et.jsxs("div", { className: yc(mR.widget, tk), children: [
    /* @__PURE__ */ et.jsx(CR, { title: "Yearly Salary Calculator", children: /* @__PURE__ */ et.jsxs("div", { className: mR.section, children: [
      /* @__PURE__ */ et.jsx(
        UD,
        {
          ...
          type: "number",
          value: F.yearlyGrossIncome,
          max: 1e7,
          onChange: D,
          name: "yearlyGrossIncome",
          error: De ? "Value must be between 0 - 10000000" : void 0
        }
      ),
      /* @__PURE__ */ et.jsx(
        Ym,
    ...
    /* @__PURE__ */ et.jsx(
      ZD,
      {
        ...
        tableData: {
          headers: ["Name", "Total"],
          data: [
            { label: "Yearly Gross Income", value: `${F.yearlyGrossIncome} USD` },
            { label: "Federal Tax", value: `${F.federalTax} %` },
            { label: "State Tax", value: `${F.stateTax} %` },
            { label: "Social Security", value: `${F.socialSecurity} %` },
            { label: "Medicare", value: `${F.medicare} %` }
          ]
        },
        resultData: [
          { label: "Tax Rate Due", value: `% ${de.toFixed(2)}` },
          { label: "Tax Price Due", value: yR.format(Ye) },
          { label: "Net Income", value: yR.format(bt) }
        ]
      }
    )
  ] });
};
RD.createRoot(document.getElementById("salary-calculator")).render(
  /* @__PURE__ */ et.jsx(S0.StrictMode, { children: /* @__PURE__ */ et.jsx(ik, {}) })
);
